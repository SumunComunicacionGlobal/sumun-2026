...
define("PORTFOLIO_LIST_ID", 15403);
define("CONTACTO_ID", 21400);
...
// Admin functions
require get_template_directory() . '/inc/smn_admin-functions.php';

// Analitica
require get_template_directory() . '/inc/smn_analitica.php';
